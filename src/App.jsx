...
function App() {
    return (
        <div>
            <Navbar />
            <Section secCim='Termés felismerése és osztályozása'
            ...
            <Section secCim='Logisztika és raktározás'
                     emberImgSrc=''
                     miImgSrc=''
            ...
            <Section secCim='Költségek és hatékonyság'
                     emberImgSrc=''
                     miImgSrc=''
            ...
            <Section secCim='Adaptáció és problémamegoldás'
                     emberImgSrc=''
                     miImgSrc=''
            ...
            <Section secCim='Etikai kérdések és jövőbeli kilátások'
                     emberImgSrc=''
                     miImgSrc=''
